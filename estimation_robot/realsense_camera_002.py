...
depth_scale = depth_sensor.get_depth_scale()  # Convert depth units
...
while True:
    ...
    for result in results:
        for box in result.boxes:
            ...
            # Get 3D world coordinates (X, Y, Z) using depth info
            x_real, y_real, z_real = get_3d_coordinates(center_x, center_y, depth_frame)
            
            # Skip if depth data is not available
            ...
            print(f"3D Coordinates: X={x_real:.3f}m, Y={y_real:.3f}m, Z={z_real:.3f}m\n")
